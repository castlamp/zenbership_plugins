...
$plugin = array(
    'id'                => 'mandrill',
    'name'              => 'Mandrill',
    'description'       => 'Integrates Mandrill with the Zenbership E-Mailing.',
    'author'            => 'Castlamp',
    'author_url'        => 'https://www.castlamp.com/',
    'author_twitter'    => 'castlamp',
    'version'           => '1.0',
    'app_creator'       => 'Mandrill',
    'app_creator_url'   => 'http://www.mandrill.com/',
);
...
$db->update_option('email_plugin', 'mandrill');
