...
$plugin = array(
    'id'                => 'sinch',
    'name'              => 'Sinch',
    'description'       => 'Integrates Sinch! with the Zenbership SMS.',
    'author'            => 'Castlamp',
    'author_url'        => 'https://www.castlamp.com/',
    'author_twitter'    => 'castlamp',
    'version'           => '1.0',
    'app_creator'       => 'Sinch!',
    'app_creator_url'   => 'http://www.sinch.com/',
);
...
$options[] = array(
    ...
    'name'          => 'Sinch Phone #',
    'value'         => '',
    'description'   => 'What is your Sinch phone number? Include the +1.',
    'type'          => 'text',
    'width'         => '300',
    'maxlength'     => '',
    'options'       => '',
...
$db->update_option('sms_plugin', 'sinch');
