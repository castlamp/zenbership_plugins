...
$plugin = array(
    'id'                => 'plivo',
    'name'              => 'Plivo',
    'description'       => 'Integrates Plivo with the Zenbership SMS.',
    'author'            => 'Castlamp',
    'author_url'        => 'https://www.castlamp.com/',
    'author_twitter'    => 'castlamp',
    'version'           => '1.0',
    'app_creator'       => 'Plivo',
    'app_creator_url'   => 'http://www.plivo.com/',
);
...
$options[] = array(
    ...
    'name'          => 'Plivo Phone #',
    'value'         => '',
    'description'   => 'What is your Plivo phone number? Include the +1.',
    'type'          => 'text',
    'width'         => '300',
    'maxlength'     => '',
    'options'       => '',
...
$db->update_option('sms_plugin', 'plivo');
